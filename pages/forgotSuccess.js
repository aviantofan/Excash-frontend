    ...
    <div className='container-fluid createPin-page'>
      <div className='row'>
        ...
        <div className=' col mt-3'>
          ...
          <h4 className="mx-5 text-color3 fw-bold mt-5">Your Password Was Successfully Reset</h4>
          <p className='mx-5 mt-5 '>Your password was successfully reset and you can now access<br /> all the features in Zwallet. Login to your new account and<br /> start exploring!</p>
          <div className='row'>
